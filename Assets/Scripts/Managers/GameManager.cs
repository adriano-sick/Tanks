...
public class GameManager : MonoBehaviour
{
    ...
    private IEnumerator RoundPlaying()
    {
        ...
        m_Scoreboard.enabled = true;
        m_Scoreboard.text = m_Tanks[0].m_ColoredPlayerText + " " + m_Tanks[0].m_Wins + " X " + m_Tanks[1].m_Wins + " " + m_Tanks[1].m_ColoredPlayerText;
